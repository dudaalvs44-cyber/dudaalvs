        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-6 text-stone-300 text-sm sm:text-base leading-relaxed tracking-normal font-light text-left">
              ...
              <p>
                Neste livro, integra fundamentos científicos, neurociência e comportamento humano às práticas energéticas, apresentando uma abordagem integrativa sobre o poder da mente nos processos de saúde e cura.
              </p>
            </div>
